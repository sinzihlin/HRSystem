...
- **部門管理:** 靈活的部門結構設定
- **員工詳細資料頁面:** 提供員工完整資訊檢視，包含基本資料、請假歷史與打卡紀錄，側邊欄顯示所有員工清單，方便在不同員工之間快速切換
...
### ⏰ 出勤管理
- **打卡功能:** 記錄員工的上下班打卡時間，包含日期與時間自訂，並在員工個人資訊頁面中查看完整打卡歷史，打卡類型顯示為「上班」或「下班」
...
- [x] **打卡功能:** 實作員工打卡紀錄功能，並整合至員工個人資訊頁面。
- [x] **請假管理:** 實作員工請假申請與 HR 審核功能
- [x] **員工個人資訊頁面:** 顯示個別員工的詳細資料、請假歷史與打卡紀錄
...
### ✅ 第七階段：打卡紀錄管理 (已完成)
- [x] **員工個人資訊頁面整合打卡紀錄**
  - [x] 員工個人資訊頁面整合打卡紀錄，顯示指定員工的打卡歷史。
  - [x] 頁面內嵌表單，可直接新增該員工的打卡紀錄。
  - [x] 頁面 UI/UX 風格與薪資管理系統保持一致，包含左側員工列表側邊欄。
  - [x] 實現員工列表側邊欄的搜尋和選中功能，並能跳轉到其他員工的個人資訊頁面。
